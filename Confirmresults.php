...
$stmt->bindParam(':m8h2', $_POST["m8shpts"]);
...
$stmt->bindParam(':m1h1', $_POST["m1apts"]);
$stmt->bindParam(':m2h1', $_POST["m2apts"]);
$stmt->bindParam(':m3h1', $_POST["m3apts"]);
$stmt->bindParam(':m3h2', $_POST["m3aapts"]);
$stmt->bindParam(':m4h1', $_POST["m4apts"]);
$stmt->bindParam(':m4h2', $_POST["m4aapts"]);
$stmt->bindParam(':m5h1', $_POST["m5apts"]);
$stmt->bindParam(':m5h2', $_POST["m5aapts"]);
$stmt->bindParam(':m6h1', $_POST["m6apts"]);
$stmt->bindParam(':m6h2', $_POST["m6aapts"]);
$stmt->bindParam(':m7h1', $_POST["m7apts"]);
$stmt->bindParam(':m7h2', $_POST["m7aapts"]);
$stmt->bindParam(':m8h1', $_POST["m8apts"]);
$stmt->bindParam(':m8h2', $_POST["m8sapts"]);
$stmt->bindParam(':m9h1', $_POST["m9apts"]);
$stmt->bindParam(':m9h2', $_POST["m9aapts"]);
$stmt->bindParam(':m10h1', $_POST["m10apts"]);
$stmt->bindParam(':m10h2', $_POST["m10aapts"]);
